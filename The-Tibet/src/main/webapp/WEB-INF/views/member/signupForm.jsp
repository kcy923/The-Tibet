...
<body>
	<section>
		...
		<div class="checkbox-group">
			<div class="check-parent">
				<input type="checkbox" name="check-Agree" id="agreeChk" onclick="selectAll(this)">
				<label>전체 동의</label>
			</div>
			<div class="check-child">
				<input type="checkbox" name="check-Agree1" id="agreeChk" class="normal"> <label>개인정보
					처리방침 동의(필수)</label>
			</div>
			<div class="check-child">
				<input type="checkbox" name="check-Agree2" id="agreeChk" class="normal"> <label>서비스
					이용약관 동의(필수)</label>
			</div>
			<!-- <div class="check-child">
			...
			<div class="check-child">
				<input type="checkbox" name="user_mailSend" id="agreeChk"  value='1' id="user_mailSend"/> <label>마케팅 수신 동의</label>
	...
	function selectAll(selectAll)  {
		const checkboxes = document.querySelectorAll('input[id="agreeChk"]');
