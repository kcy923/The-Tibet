...
<body>
	<section>
		...
		<ul class="SubMenu">
			<li><a href="${contextPath}/search.do?p=1">검색 결과</a></li>
		</ul>

		<div>
			<ul class="sort">
				<li class="UnSelectMenu-chk"><a href="${contextPath}/search.do?p=2">low price</a></li>
				<li class="UnSelectMenu"><a href="${contextPath}/search.do?p=3">high price</a></li>
				<li class="UnSelectMenu"><a href="${contextPath}/search.do?p=4" >name</a></li>
				<li class="UnSelectMenu"><a href="${contextPath}/search.do?p=1">new arrival</a></li>
			</ul>
		</div>
