...
<body>
	<section>
		...
		<ul class="SubMenu">
			<li><a href="${contextPath}/pants.do?p=1">ALL</a></li>
			<li><a href="${contextPath}/pants-1.do?p=1">팬츠</a></li>
			<li class="SelectMenu"><a href="${contextPath}/pants-2.do?p=1">쇼츠</a></li>
		</ul>

		<div>
			<ul class="sort">
				<li class="UnSelectMenu-chk"><a href="${contextPath}/pants.do?p=2">low price</a></li>
				<li class="UnSelectMenu"><a href="${contextPath}/pants.do?p=3">high price</a></li>
				<li class="UnSelectMenu"><a href="${contextPath}/pants.do?p=4">name</a></li>
				<li class="UnSelectMenu"><a href="${contextPath}/pants.do?p=1">new arrival</a></li>
			</ul>
		</div>
